...
async function generated_error() {
    const response = await api_post(config.endpoint_login, { method: 'login', parameters: { email: 'kajzardaniel@gmail.com', password: 'Heslosit_1' } });
    alert(response.data);
...
async function generated_error1() {
    try {
        const response = await ApiService.post(config.endpoint_login, { method: 'login', parameters: { email: 'kajzardaniel@gmail.com', password: 'Heslosit_1' } });
        alert(response.data);
        if (response.data.result) {
            alert(response.data.response);
        } else {
        ...
        <div class="md:w-1/2">
            <div class="card flex flex-col gap-4">
                ...
                <div class="flex flex-wrap gap-2">
                    <Button @click="generated_error" label="Generate Error"></Button>
