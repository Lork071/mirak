...
export default {
    ...
    setup() {
         ...
         *********************** STATIC SET UP ***********************
         *************************************************************/
        const OnlyIntroPage = true; /* Only first intro page */
        /*************************************
         ********** USAGE DEFINITION **********
         **************************************/
...
<template>
    ...
    <div class="intro-page-first-part">
        ...
        <div v-if="!OnlyIntroPage" class="intro-page-scroll-icon">
            <span><i class="fa-solid fa-arrow-down"></i> {{ $t('intro_page_scroll_down') }} <i class="fa-solid fa-arrow-down"></i></span>
        </div>
    </div>

    <header v-if="!OnlyIntroPage" class="intro-page-navbar">
        <div class="intro-page-navbar-container">
            ...
            <nav class="intro-page-navbar-menu" :class="{ open: isMobileMenuOpen }">
                <ul>
                    ...
                    <li v-if="isLive" class="intro-page-ahref-live">
                ...
                <Button v-if="UseMirakAccount" to="/auth/login" rounded
    ...
    <div v-if="!OnlyIntroPage" class="intro-page-wraper">
        ...
        <div v-if="UseIntroFeatures && UseIntro" id="features" class="intro-page-titles px-6 lg:px-20 mt-8 mx-0 lg:mx-20">
            <div class="grid grid-cols-12 gap-4 justify-center">
                ...
                <div class="col-span-12 md:col-span-12 lg:col-span-4 p-0 lg:pr-8 lg:pb-8 mt-6 lg:mt-0">
                    <div style="height: 200px; padding: 2px; border-radius: 10px; background: linear-gradient(90deg, var(--primary-color), var(--primary-contrast-color)), linear-gradient(180deg, var(--primary-color), var(--primary-contrast-color))">
        ...
        <div class="layout-footer">&copy; Mírák {{ new Date().getFullYear() }} Supported by<a href="https://primevue.org" target="_blank" rel="noopener noreferrer" class="text-primary font-bold hover:underline">PrimeVue</a></div>
    </div>
</template>
