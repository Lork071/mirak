        ...
        <div class="flex flex-col items-center justify-center">
            <svg
                        ...
                        <g
                            ...
                            id="layer1"
                            transform="translate(76.27383,-67.512647)">
                            <path
            ...
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, color-mix(in srgb, var(--primary-color), transparent 60%) 10%, var(--surface-ground) 30%)">
                <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20 flex flex-col items-center" style="border-radius: 53px">
                    ...
                    <h1 class="text-surface-900 dark:text-surface-0 font-bold text-3xl lg:text-5xl mb-2">{{ $t('not_found_page_title') }}</h1>
                    <div class="text-surface-600 dark:text-surface-200 mb-8">{{ $t('not_found_page_description') }}</div>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0 block">{{ $t('not_found_page_option_1_title') }}</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center py-8 border-surface-300 dark:border-surface-500 border-b">
                        <span class="flex justify-center items-center border-2 border-primary text-primary rounded-border" style="height: 3.5rem; width: 3.5rem">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">{{ $t('not_found_page_option_2_title') }}</span>
                        </span>
                    </router-link>
                    <router-link to="/" class="w-full flex items-center mb-8 py-8 border-surface-300 dark:border-surface-500 border-b">
                        ...
                        <span class="ml-6 flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 lg:text-xl font-medium mb-0">{{ $t('not_found_page_option_3_title') }}</span>
                        </span>
                    </router-link>
                    <Button as="router-link" to="/">{{ $t('not_found_page_button') }}</Button>
                </div>
            </div>
        </div>
    </div>
