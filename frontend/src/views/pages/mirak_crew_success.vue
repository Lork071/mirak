...
const status_result = ref(true);
const load = ref(true);
const status_message = ref('volunteer_form_sent');
</script>
...
<template>
    ...
    <div class="surface-ground flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-20 px-8 sm:px-20" style="border-radius: 53px">
                    <div class="text-center mb-8">
                        ...
                        <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">{{ $t('successful') }}</div>
                    </div>
                    ...
                    <div v-if="load" class="flex flex-col items-center justify-center">
                        ...
                        <Button v-if="status_result" :label="$t('back_to_home')" class="w-full mt-2 mb-2" @click="() => router.push('/')"></Button>
                    </div>
