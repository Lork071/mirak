    ...
    <div class="surface-ground flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
        <div class="flex flex-col items-center justify-center">
            <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                <div class="w-full surface-card py-20 px-8 sm:px-20 sm:w-[500px]" style="border-radius: 53px">
                    ...
                    <div>
                        ...
                        <InputText id="email1" type="text" class="w-full mb-8" v-model="email" />
                        ...
                        <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                            ...
                            <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary" @click="() => router.push('/auth/forgot-password')">{{ $t('sign_in_forgot_pass') }}</span>
                        </div>
